export const TAKUMI_PAY_IDL = {
  ...
  metadata: {
    ...
    spec: "0.1.0",
    description:
      "TakumiPay Solana Program \u2014 merchant payments, transactions, point deposits",
  },
  instructions: [
    {
    ...
    },
    {
      ...
      discriminator: [46, 188, 165, 50, 78, 78, 42, 232],
      accounts: [
        {
          name: "owner",
          writable: true,
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const",
                value: [97, 108, 108, 111, 119, 101, 100, 95, 112, 116],
              },
              {
                kind: "account",
                path: "config",
    ...
    },
    {
      ...
      discriminator: [2, 184, 195, 105, 138, 142, 154, 75],
      accounts: [
        {
          name: "owner",
          signer: true,
    ...
    },
    {
      ...
      discriminator: [15, 148, 64, 222, 85, 10, 108, 111],
      accounts: [
        {
          name: "payer",
          writable: true,
    ...
    },
    {
      ...
      discriminator: [102, 151, 178, 25, 248, 110, 102, 235],
      accounts: [
        {
          name: "payer",
          writable: true,
    ...
    {
      name: "deposit_points",
      discriminator: [184, 73, 55, 238, 103, 247, 76, 228],
      accounts: [
        {
          name: "payer",
          writable: true,
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const",
                value: [112, 111, 105, 110, 116, 95, 114, 101, 102],
              },
              {
                kind: "account",
                path: "config",
    ...
    },
    {
      ...
      discriminator: [56, 220, 82, 197, 255, 165, 245, 186],
      accounts: [
        {
          name: "owner",
          signer: true,
    ...
    },
    {
      ...
      discriminator: [199, 121, 223, 85, 242, 0, 202, 194],
      accounts: [
        {
          name: "owner",
          signer: true,
    ...
    },
    {
      ...
      discriminator: [6, 32, 215, 30, 94, 56, 25, 115],
      accounts: [
        {
          name: "payer",
          writable: true,
            ...
            seeds: [
              {
                kind: "const",
                value: [
                  112, 108, 97, 116, 102, 111, 114, 109, 95, 102, 101, 101,
                ],
              },
              {
                kind: "account",
    ...
    },
    {
      ...
      discriminator: [15, 243, 125, 245, 253, 85, 95, 176],
      accounts: [
        {
          name: "payer",
          writable: true,
    ...
    },
    {
      ...
      discriminator: [153, 8, 176, 235, 189, 140, 146, 223],
      accounts: [
        {
          name: "owner",
          writable: true,
    ...
    },
    {
      ...
      discriminator: [237, 16, 48, 242, 33, 126, 89, 118],
      accounts: [
        {
          name: "owner",
          writable: true,
    ...
    },
    {
      ...
      discriminator: [144, 238, 219, 97, 210, 50, 23, 119],
      accounts: [
        {
          name: "owner",
          signer: true,
    ...
    },
    {
      ...
      discriminator: [79, 86, 19, 104, 153, 181, 219, 165],
      accounts: [
        {
          name: "authority",
          signer: true,
            ...
            seeds: [
              {
                kind: "const",
                value: [
                  115, 112, 101, 110, 100, 105, 110, 103, 95, 108, 105, 109,
                  105, 116,
                ],
              },
              {
    ...
    },
    {
      ...
      discriminator: [188, 153, 14, 109, 50, 127, 169, 158],
      accounts: [
        {
          name: "owner",
          signer: true,
    ...
    },
    {
      ...
      discriminator: [96, 130, 106, 97, 132, 125, 31, 147],
      accounts: [
        {
          name: "owner",
          signer: true,
    ...
    },
    {
      ...
      discriminator: [62, 166, 15, 135, 176, 30, 247, 42],
      accounts: [
        {
          name: "owner",
          signer: true,
    ...
    },
    {
      ...
      discriminator: [97, 166, 239, 120, 245, 106, 255, 68],
      accounts: [
        {
          name: "owner",
          signer: true,
        ...
        },
        {
          ...
          relations: ["platform_fee_account"],
        },
        {
          name: "platform_fee_account",
          writable: true,
    ...
    },
    {
      ...
      discriminator: [247, 179, 81, 65, 213, 14, 71, 230],
      accounts: [
        {
          name: "owner",
          signer: true,
  ...
  accounts: [
    ...
    },
    {
      ...
      discriminator: [135, 129, 14, 21, 72, 249, 88, 234],
    },
    {
      name: "Config",
    ...
    },
    {
      ...
      discriminator: [91, 127, 5, 117, 233, 164, 146, 91],
    },
    {
      name: "PlatformFeeAccount",
      discriminator: [3, 58, 42, 131, 224, 90, 94, 216],
    },
    {
      name: "PointDepositRecord",
      discriminator: [201, 197, 66, 68, 123, 98, 130, 44],
    },
    {
      name: "RefRecord",
      discriminator: [207, 231, 200, 34, 52, 56, 43, 237],
    },
    {
      name: "SpendingLimit",
      discriminator: [10, 201, 27, 160, 218, 195, 222, 152],
    },
    {
  ...
  events: [
    ...
    },
    {
      ...
      discriminator: [26, 237, 252, 25, 217, 82, 140, 116],
    },
    {
      name: "ContractPausedToggled",
      discriminator: [253, 21, 57, 17, 120, 73, 183, 234],
    },
    {
      name: "MaxTransactionAmountUpdated",
      discriminator: [158, 28, 178, 247, 170, 56, 59, 73],
    },
    {
      name: "MerchantBackingSwept",
      discriminator: [182, 240, 31, 34, 17, 106, 29, 133],
    },
    {
      name: "MerchantPaymentProcessed",
      discriminator: [177, 114, 82, 110, 36, 237, 19, 122],
    },
    {
    ...
    },
    {
      ...
      discriminator: [11, 134, 55, 195, 74, 64, 122, 35],
    },
    {
      name: "PointDepositCreated",
      discriminator: [129, 49, 90, 82, 123, 73, 105, 63],
    },
    {
      name: "PointDepositsPausedToggled",
      discriminator: [235, 30, 145, 78, 56, 1, 240, 250],
    },
    {
      name: "PointTokenAdded",
      discriminator: [56, 53, 236, 45, 122, 158, 212, 101],
    },
    {
      name: "PointTokenRemoved",
      discriminator: [38, 92, 22, 15, 181, 36, 64, 183],
    },
    {
      name: "TransactionCreated",
      discriminator: [55, 194, 205, 6, 76, 142, 153, 217],
    },
    {
      name: "WithdrawEvent",
    ...
    },
    {
      ...
      discriminator: [119, 175, 207, 80, 186, 237, 229, 9],
    },
    {
      name: "WithdrawalDelayUpdated",
      discriminator: [255, 161, 164, 83, 36, 246, 65, 108],
    },
    {
    ...
    },
    {
      ...
      discriminator: [116, 223, 187, 38, 197, 80, 19, 250],
    },
  ],
  errors: [
    {
